...
client.on("messageCreate", function(message) {
    ...
    console.log(cheese)
    if (cheese === "449162438605012994") {
        console.log('draa is back at it')
    }
    else {
        ...
        if (command === "start") {
            ...
            if (cheese === "674733684787773440") {
                ...
                setTimeout(() => {
                    message.channel.send('threadstart');
                }, 5000 * 60 * 60);
